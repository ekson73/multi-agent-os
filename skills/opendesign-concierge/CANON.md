...
| C7 | **Cloudflare preview needs an account-owned token** (a secret manager, HUMAN_DOMAIN). | Per the operator's CI-token rule (account-owned `cfat_`, survives offboarding). |
