...
> **Inventory refresh 2026-08-25**: table below is generated from each skill's frontmatter `description` (89 skills; `openrig-concierge` and `instrument-self-heal-relay` added by hand 2026-09-23). Dependency graph covers the session/agentic-tool/governance core families (edges extracted from `maos:` refs, `[[wikilinks]]`, `skills/` path refs in SKILL.md bodies).
