...
- **GDPR Art.22 / LGPD Art.20** — any action that constitutes/determines/executes a decision with a **legal or similarly-significant effect on a natural person** (credit/eligibility · pricing · hiring/termination · benefit/access grant-or-deny · account-suspension · consequential content-moderation) → **HARD → mandatory-HITL**. A converged council + red-team is **still "solely automated"** (SCHUFA CJEU C-634/21 rubber-stamp doctrine — only *meaningful* human involvement removes it) → it is NOT the Art.22(3) human-intervention safeguard. The Art.22(2) exceptions (explicit consent · contract-necessity · authorized-by-law) are **operator-HITL-only, never council-invocable**; boundary drawn conservatively (GDPR = the stricter floor; LGPD Art.20 §3's human-reviewer was vetoed).
